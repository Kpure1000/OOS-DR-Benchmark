...
import random
import torch
from .trainer import CDRTrainer
...
class ICLPTrainer(CDRTrainer):
    def __init__(self, clr_model, data_matrix, configs, result_save_dir, config_path, device='cuda',
                 log_path="log.txt"):
        CDRTrainer.__init__(self, clr_model, data_matrix, configs, result_save_dir, config_path, device, log_path)
        self.link_info = None
        self.dataset = None
